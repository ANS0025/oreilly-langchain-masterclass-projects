...
def create_docs(pdf_files, uuid):
  ...
  for pdf_file in pdf_files:
    ...
    docs.append(Document(
      ...
      metadata={ "uuid": uuid, "id": pdf_file.file_id, "source": pdf_file.name, "type=": pdf_file.type, "size": pdf_file.size }
    ))
...
def retrieve_relevant_docs(job_description, num_resumes, vector_store):
  ...
  Returns:
    List of Document objects
  """
  similar_docs = vector_store.similarity_search_with_score(job_description, k=num_resumes)
  return similar_docs
